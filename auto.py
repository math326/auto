...
def ensure_or_install_command(command_name):
    ...
    package_overrides = {
        ...
        "ar": {"apt": "binutils", "pacman": "binutils"},
        "gunzip": {"apt": "gzip", "pacman": "gzip"},
        "gzip": {"apt": "gzip", "pacman": "gzip"},
        "zcat": {"apt": "gzip", "pacman": "gzip"},
        "bunzip2": {"apt": "bzip2", "pacman": "bzip2"},
        "bzip2": {"apt": "bzip2", "pacman": "bzip2"},
        "bzcat": {"apt": "bzip2", "pacman": "bzip2"},
        "xz": {"apt": "xz-utils", "pacman": "xz"},
        "unxz": {"apt": "xz-utils", "pacman": "xz"},
        "xzcat": {"apt": "xz-utils", "pacman": "xz"},
